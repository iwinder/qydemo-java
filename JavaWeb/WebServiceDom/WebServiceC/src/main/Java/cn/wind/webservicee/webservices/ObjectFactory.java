 ...
 * generated in the cn.wind.webservicee.webservices package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("webServices.WebServiceE.wind.cn", "say");
    private final static QName _SayResponse_QNAME = new QName("webServices.WebServiceE.wind.cn", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.wind.webservicee.webservices
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "webServices.WebServiceE.wind.cn", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "webServices.WebServiceE.wind.cn", name = "sayResponse")
