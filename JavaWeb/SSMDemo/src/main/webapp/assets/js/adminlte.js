...
+function ($) {
  ...
  Tree.prototype.expand = function (tree, parent) {
    ...
    if (this.options.accordion) {
      ...
      // console.log(tree)
      // console.log(event)
      console.log("--------NotopenEnd-------")
    parent.addClass(ClassName.open)
    tree.slideDown(this.options.animationSpeed, function () {
      // $(this.element).trigger(expandedEvent)
      //   mainMenuClickFunc.call(tree);
    }.bind(this))
  }
...
function goMenu(menuController, param) {
    mainMenuClickFunc.call($(".treeview-menu li a[menu-controller='" + menuController + "']"), param);
}
/* ControlSidebar()
 * ===============
