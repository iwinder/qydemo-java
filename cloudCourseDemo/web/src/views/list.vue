        ...
        <div class="header-nav">
            <div class="clearfix">
                ...
                <div class="row">
                    ...
                    <a v-for="o in level1" :key="o.id" v-on:click="onClickLevel1(o.id)" v-bind:id="'category-' + o.id" href="javascript:;">{{o.name}}</a>
                    </div>
                </div>
                </div>
            </div>
        ...
        <div class="skill clearfix">
            <div class="container">
                ...
                <div class="col-12">
                    ...
                    <a v-for="o in level2" :key="o.id" v-on:click="onClickLevel2(o.id)" v-bind:id="'category-' + o.id" href="javascript:;">{{o.name}}</a>
         ...
         <div class="album py-5 bg-light">
              <div class="container">
                  ...
                  <div class="row">
                      <div v-for="o in courses" :key="o.id" class="col-md-4">
