                    ...
                    <div class="modal-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10"> 
                                    <file v-bind:input-id="'image-upload'" v-bind:text="'上传头像'"  
...
<script>
    ...
    export default {
        ...
        mounted: function() {
            // this.$parent.activeSidebar("sidebar-business-teacher");
            let _this = this;
            _this.list(1);
        },
        methods: {
            ...
            del(teacherId) {
                ...
                Confirm.show('确认删除？',"删除后不可恢复，确认删除？", function(){
                    Loading.show();
                    _this.$ajax.delete(process.env.VUE_APP_SERVER + "/business/admin/teacher/delete/"+teacherId).then((response)=>{
                        Loading.hide(_this.$isDebug);
