...
public class DateTimeUtils {
    ...
    public static boolean compareDateIgnoreMillisecond(Date date, Date compareDate) {
        return date == null && compareDate == null ? true
                : (date == null && compareDate != null ? false
                : (date != null && compareDate == null ? false
                : date.getTime() / 1000L == compareDate.getTime() / 1000L));
    }
...
//                        ? null
//                        : (new DateTime(Integer.parseInt(yearStr.trim()), Integer.parseInt(monthStr.trim()),
//                        Integer.parseInt(dateStr.trim()), Integer.parseInt(hmsarr[0].trim()),
//                        Integer.parseInt(hmsarr[1].trim()), Integer.parseInt(hmsarr[2].trim()), 0))
//                        .toDate();
//            }
...
//    }
    ...
    public static Date getCurrentDate() {
        return formatDateString(DateTimeUtils.format(new Date(), YEAR_MONTH_DAY),YEAR_MONTH_DAY);
    }

    public static Date getYesterday() {
        DateTime currentDate = new DateTime();
        return formatDateString(DateTimeUtils.format(currentDate.plusDays(-1).toDate(), YEAR_MONTH_DAY),YEAR_MONTH_DAY);
    }
